...
urlpatterns = patterns('',
	...
	url(r'^(?P<asset_id>\d+)/edit/$', 'assets.views.ajax_edit_asset', name="ajax_edit_asset"),
	url(r'^(?P<asset_id>\d+)/update/$','assets.views.ajax_update_asset', name='ajax_update_asset'),
